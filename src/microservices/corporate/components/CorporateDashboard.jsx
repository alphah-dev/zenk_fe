      ...
      <div className="corp-shell">
        ...
        <header className="corp-header">
          <div className="corp-logo-wrap">
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 700, color: '#1a1a1a' }}>{company}</div>
        ...
        <div className="corp-content">
          ...
          {!loading && activeTab === 'circles' && <CorpCirclePerf circlesPerf={circlesPerf} />}
          {!loading && activeTab === 'employees' && <CorpEmployees employees={employees} />}
          {!loading && activeTab === 'csr-account' && <CorpCSRAccount csrAccount={csrAccount} />}

          {!loading && (activeTab === 'impact' || activeTab === 'kia') && (
            <div className="c-coming-soon">
              <h3>{activeTab === 'kia' ? 'Kia AI Strategy Assistant' : 'Impact Certification'}</h3>
              <p>
                {activeTab === 'kia'
                  ...
                  : 'Impact certification reports and compliance documents will be available here in the next release.'}
              </p>
            </div>
          )}
        </div>
